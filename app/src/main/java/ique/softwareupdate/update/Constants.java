...
// json {"url":"http://192.168.205.33:8080/Hello/app_v3.0.1_Other_20150116.apk","versionCode":2,"updateMessage":"版本更新信息"}
    ...
    static final String APK_DOWNLOAD_URL = "appURI";
    static final String APK_UPDATE_CONTENT = "msg";
    static final String APK_VERSION_CODE = "latestVersion";
    static final String APK_VERSION_STATUS = "success";
    ...
    static final String UPDATE_URL = "http://daitechpharma.com/php_stock/webservicelib/daitechagent/checkVersion.php";
